export const fa = {
  ...
  chat: {
    ...
    budgetExceeded: 'سهمیه‌ی هوش مصنوعی امروزِ پلن شما تمام شده است. فردا دوباره فعال می‌شود، یا می‌توانید کیف پول خود را شارژ یا پلن خود را ارتقا دهید.',
  ...
  budget: {
    ...
    walletInsufficient: 'موجودی کیف پول برای ادامه کافی نیست',
    sessionLimit: 'به سقف مصرف امروزِ پلن شما رسیدید. فردا دوباره فعال می‌شود، یا می‌توانید کیف پول خود را شارژ یا پلن خود را ارتقا دهید.',
  },
  upsell: {
