...
INSERT INTO "kie_video_models" (
  ...
  0.07875, 'تست واقعی ۱۴۰۵/۰۶/۱۵: ۴ث/۷۲۰p/متن‌محض = ۶۳ credit. نرخ ۱credit=$۰.۰۰۵ دیگر حدس نیست — کاربر مستقیم از حساب Kie.ai تأیید کرد ($۵ = ۱۰۰۰ credit). با این حال این هنوز فقط یک نقطه‌داده است (فقط ۴ث/۷۲۰p/بدون مرجع)، نه منحنی کامل قیمت روی مدت/رزولوشن/عکس-ویدیوی مرجع (بخش ۶.۲ سند)', now()
);
