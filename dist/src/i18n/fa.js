...
exports.fa = {
    ...
    payment: {
        ...
        description: (planName) => `خرید اشتراک ${planName}`,
    ...
    sms: {
        otpText: (code) => `کد تأیید دستیار AI: ${code}\nاین کد ۲ دقیقه اعتبار دارد`,
        subscriptionActivated: (planName, refId) => `اشتراک ${planName} شما فعال شد. کد پیگیری: ${refId}`,
